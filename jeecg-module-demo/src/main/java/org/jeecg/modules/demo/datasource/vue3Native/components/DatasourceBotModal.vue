<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <datasource-bot-form ref="formComponent" :disabled="formDisabled" @success="submitSuccess"></datasource-bot-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import DatasourceBotForm from './DatasourceBotForm.vue';
