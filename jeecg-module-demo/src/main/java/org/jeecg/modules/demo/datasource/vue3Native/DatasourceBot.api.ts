...
enum Api {
  ...
  queryDataById = '/datasource/datasourceBot/queryById',
 ...
 * @param params
 */
export const queryDatasourceBotLableListByMainId = (id) => defHttp.get({url: Api.datasourceBotLableList, params:{ id }});
